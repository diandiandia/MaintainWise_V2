...
echo "-----------------------------------------------------------------------"
echo "常用运维命令："
echo "  - 查看服务状态:   ./maintainwise.sh status  (或 ./mw.sh status)"
echo "  - 停止后台服务:   ./maintainwise.sh stop    (或 ./mw.sh stop)"
echo "  - 重启后台服务:   ./maintainwise.sh restart (或 ./mw.sh restart)"
echo "  - 实时跟踪日志:   ./maintainwise.sh logs    (或 tail -f logs/maintainwise.log)"
echo "======================================================================="
